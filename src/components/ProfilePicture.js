...
const ProfilePicture = ({ picture }) => {
    ...
    z-index:10;
    border-radius : 65% 35% 32% 68% / 30% 53% 47% 70%;
    ...
    return (
        <div>
        <img css={pictureStyle} className='w-32 bg-pink md:w-36 lg:w-44 2xl:w-60 -mt-4 md:-mt-0 absolute' src={picture} alt="profile" />
