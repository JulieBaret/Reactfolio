...
// inline-flex 2xl:text-lg items-center rounded-full border-2 border-black bg-black px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-black
