            ...
            <div className='flex flex-wrap items-center'>
                <div className='grow-0 shrink-0 basis-auto block lg:flex w-full md:w-4/12'>
                    <img src={project.picture}
                        className='w-full rounded-t-lg md:rounded-tr-none md:rounded-bl-lg -mb-8 md:-mb-0' alt={project.name} />
                </div>
                <div className='grow-0 shrink-0 basis-auto w-full md:w-8/12'>
                    <div className='px-6 py-12 md:px-12'>
                        <div className='text-3xl 2xl:text-4xl md:text-2xl font-bold mb-3 flex flex-col lg:flex-wrap lg:flex-row'>
                            ...
                            <span className='md:text-middle-pink text-pink uppercase font-semibold text-lg md:text-2xl 2xl:text-3xl md:font-light'>{project.type}</span>
                        </div>
                        {/* Project brief */}
                        ...
                        {project.stack && (
                            <ul className=' mb-2 md:mb-3 flex flex-wrap'>
