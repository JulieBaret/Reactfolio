                ...
                <ol class="border-l-2 border-transparent">
                    <li>
                        <div class="flex flex-start items-center">
                            ...
                            <div className='text-very-dark-grey leading-5 font-semibold text-lg md:text-xl 2xl:text-2xl md:-mt-2 -mt-4 flex flex-wrap'>Baccalauréat scientifique</div>
                        </div>
                        <div className='ml-6 mb-2 pb-6'>
                            <p className='inline-block text-middle-pink uppercase text-xs font-medium md:font-light md:text-base 2xl:text-lg'>2011</p>
                        </div>
                    </li>
                </ol>
            </div>
