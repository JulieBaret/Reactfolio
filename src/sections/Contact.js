...
const Contact = () => {
  ...
  const { social } = about
  return (
    <section className='md:mt-6 2xl:mt-8 h-auto w-[90vw] flex flex-col self-center' id='contact'>
      <div className='2xl:mt-6 2xl:mb-6 flex flex-col justify-between h-[90vh]'>
        <div className='text-4xl font-extrabold text-red lg:text-5xl 2xl:text-6xl'>Let's keep <span class="underline underline-offset-3 decoration-8 decoration-red">in touch</span></div>
